...
export default function ViewCard() {
  ...
  return (
    <Box>
      ...
      {
        recentlyData.map((x) => <MediaCard img={x.img} icon={x.icon} title={x.title} p={x.p} price={x.price} person={x.person} /> )
      }
      <Box
      sx={{
        ...
        <Typography>Enjoy confortable transfers in shared coaches <br/> Enjoy confortable transfers in shared coaches </Typography>
        </Box>
